...
run 'curl -L https://github.com/bburridge/launchpad/raw/master/template/config/app_config.yml > config/app_config.yml'
run 'curl -L https://github.com/bburridge/launchpad/raw/master/template/config/initializers/load_app_config.rb > config/initializers/load_app_config.rb'
